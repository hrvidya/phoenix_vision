...
with open(log_file_path, "w") as f:
    ...
    for failure_name, commands in scenarios:
        ...
        while time.time() - start < duration:
            ...
            airspeed = get("/velocities/airspeed-kt")
            ...
            # ✅ Always keep order consistent
            row = f"{t},{lat},{lon},{alt},{airspeed},{heading},{pitch},{roll},{vsi},{failure_name}\n"
            f.write(row)
            print(row.strip())
            time.sleep(interval)

        # reset after each failure
